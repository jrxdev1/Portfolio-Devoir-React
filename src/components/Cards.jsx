function Card ({infos}) {
    ...
    return (
        <div className="flex flex-col items-center w-full md:w-1/4 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 hover:shadow-md">
            <img src={urlImage} alt="" />
            <h2 className="text-xl font-semibold mb-2 mt-2">{infos.title}</h2>
            <p className="mb-2">{infos.description}</p>
            ...
            <p className="w-full p-3 bg-gray-100 border border-gray-300 self-end text-center text-gray-600">{infos.realisation}</p>
        </div>
    )
}
