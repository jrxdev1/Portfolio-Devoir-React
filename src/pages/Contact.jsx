...
return (
    <div className="p-3 max-w-170">
        ...
        <form className="mt-3 flex flex-col gap-1">
            ...
            <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 m-auto mt-3 max-w-25">Envoyer</button>
        </form>
    </div>
)
}
...
function Contact () {
    return (
        <div>
            ...
            <div className="grid grid-cols-2 mb-8 max-w-350 m-auto mt-3 p-3 border border-solid border-gray-300 shadow-md rounded-lg shadow-s ">
